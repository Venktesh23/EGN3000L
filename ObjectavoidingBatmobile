...
void loop() { 
  ...
  if (distance <= 15)  // This line checks if the distance is less than 15 
...
else if (distance <= 30) // This line checks if the distance is between 15 and 30 
...
else if (distance <= 45)  // This line checks if the distance is less than 45 
...
else// This line tells us that the distance is more than 45  
